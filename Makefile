...
tmp/net.o: tmp src/net.h src/net.c
	$(CC) $(CFLAGS) -c -o tmp/net.o src/net.c

tmp/cprefresh_ass.o: tmp src/cprefresh_default.s src/cprefresh_vfp.s src/cprefresh_arm.s
	if [ $(REFRESH) = "" ]; then \
...
tmp/cprefresh.o: tmp src/cprefresh.h src/cprefresh.c 
	$(CC) -c $(CFLAGSNO) -o tmp/cprefresh.o src/cprefresh.c

bin/playhrt: bin src/version.h tmp/net.o src/playhrt.c tmp/cprefresh.o tmp/cprefresh_ass.o
	$(CC) $(CFLAGSNO) -o bin/playhrt src/playhrt.c tmp/net.o tmp/cprefresh.o tmp/cprefresh_ass.o -lasound -lrt

bin/playhrt_ALSANC: bin src/version.h tmp/net.o src/playhrt.c tmp/cprefresh.o tmp/cprefresh_ass.o
...
bin/playhrt_static: bin src/version.h tmp/net.o src/playhrt.c tmp/cprefresh.o tmp/cprefresh_ass.o
